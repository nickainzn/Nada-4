...
Translator.Frases = loadstring(game:HttpGet("https://raw.githubusercontent.com/nickainzn/Nada-22/main/Nadaaquiseuotario/Translations.lua"))()
...
local Libary = loadstring(game:HttpGet("https://raw.githubusercontent.com/makshggdisiegrdmsi/-----716219162278219/main/remake.lua%20(1).txt"))()

workspace.FallenPartsDestroyHeight = -math.huge

local Window = Libary:MakeWindow({
    Title = "Nick Hub| Brookhaven RP",
    SubTitle = "BY: <Nick> <Lynix-dev> <Horakage> <The darkness> <Drip client>",
    LoadText = "Carregando Nick Hub",
    Flags = "NickHub_Broookhaven"
})
Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://124452080814101", BackgroundTransparency = 1 },
...
local function copyDiscordLink()
    setclipboard("https://discord.gg/egSxthKBpm")
end
...
Window:Dialog({
    ...
    Text = Translator:traduzir("E aí! Você acaba de dar o play no Nick Hub!"),
    Options = {
        {"Discord", function()
            copyDiscordLink()
        end},
...
Tabs.M:AddDiscordInvite({
    Name = Translator:traduzir("Nick Hub"),
    ...
    Invite = "https://discord.gg/egSxthKBpm"
})
...
local scoutTrack = Tabs.H:AddParagraph({Translator:traduzir("Dev: Nick")})
